...
public:
  ...
  void MergeLists(UnsortedType<ItemType>& l_b, UnsortedType<ItemType>& result);
...
template <class ItemType>
void  UnsortedType<ItemType>::MergeLists(UnsortedType<ItemType>& l_b, UnsortedType<ItemType>& result) {
