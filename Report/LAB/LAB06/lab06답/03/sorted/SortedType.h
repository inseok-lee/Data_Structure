...
public:
  ...
  void MergeLists(SortedType<ItemType>& l_b, SortedType<ItemType>& result);
...
template <class ItemType>
void  SortedType<ItemType>::MergeLists(SortedType<ItemType>& l_b, SortedType<ItemType>& result) {

	NodeType<ItemType>* a_location = listData;
	NodeType<ItemType>* b_location = l_b.listData;

	// result는 애초에 정렬해서 들어가기 때문에 InsertItem을 이용하면 비교없이 넣을 수 있음
	/*
